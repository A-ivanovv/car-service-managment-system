...
from .forms import CustomerForm, CustomerSearchForm, CarFormSet, EmployeeForm, EmployeeSearchForm, DaysOffForm, SkladForm, SkladSearchForm, OrderForm, OrderItemForm, OrderSearchForm, OrderItemFormSet
...
def order_convert_to_invoice(request, pk):
    ...
    if request.method == 'POST':
        ...
        messages.success(request, f'Поръчка {order.order_number} е конвертирана в фактура успешно!')
